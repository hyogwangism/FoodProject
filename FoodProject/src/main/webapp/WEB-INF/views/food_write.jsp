...
<body>
	...
	<div id="food-details">
		<form method="post" action="food_write_ok"
			...
			가게 이름: <input type="text" name="food_place" id="food_place"><br>
			음식이름: <input type="text" name="food_name" id="food_name"><br>
			맛: <input type="text" name="food_taste" id="food_taste"><br>
			양: <input type="text" name="food_amount" id="food_amount"><br>
			지역: <input type="text" name="food_location" id="food_location"><br>
			종류: <input type="text" name="food_type" id="food_type"><br>
			공간: <input type="text" name="food_space" id="food_space"><br>
			음식 가격: <input type="text" name="food_price" id="food_price"><br>
			주차: <input type="text" name="food_parking" id="food_parking"><br>
			...
			<div class="file-input-wrapper">
				<table>
					<tbody id="insert">
						<tr>
							<td>사진첨부:<br> <input type="file" name="food_photo01" id="food_photo01" required />
							</td>
