...
<body>
		...
		<div class="form-group row pull-right">
			...
			<h1>회원 목록 검색</h1>
					<select name="search_type" id="search_type">
   						...
   						<option value="user_gender" <c:if test="${search_type == 'user_gender'}"> ${'selected'}</c:if>>성별</option>
		...
		<table class="table"
			...
			<thead>
				<tr>
					...
					<th
						style="background-color: lightgray; text-align: center; width: 10%;">아이디</th>
					<th
						style="background-color: lightgray; text-align: center; width: 10%;">이름</th>
					<th
						style="background-color: lightgray; text-align: center; width: 5%;">성별</th>
					<th
						style="background-color: lightgray; text-align: center; width: 15%;">생년월일</th>
					<th
						style="background-color: lightgray; text-align: center; width: 30%px;">이메일</th>
					<th
						style="background-color: lightgray; text-align: center; width: 30%px;">전화번호</th>
				</tr>
			</thead>
	...
	<div align="center">
	<button type="button" onclick="location.href='/admin_main';">뒤로가기</button>
	</div>
</body>
</html>